...
public class Size {
    ...
    public Size(com.example.kevin.kcamera.Ex.Size size) {
    ...
    public com.example.kevin.kcamera.Ex.Size toPortabilitySize() {
        return new com.example.kevin.kcamera.Ex.Size(width, height);
    }
    ...
    public static List<Size> convert(List<com.example.kevin.kcamera.Ex.Size> sizes) {
        ArrayList<Size> converted = new ArrayList<>(sizes.size());
        for (com.example.kevin.kcamera.Ex.Size size : sizes) {
