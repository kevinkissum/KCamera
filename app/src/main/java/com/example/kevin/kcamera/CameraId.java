...
public final class CameraId {
    ...
    public static CameraId from(String camera2Id) {
     ...
     * into an api1 id.
     */
    private static Integer computeLegacyIdFromCamera2Id(String camera2Id) {
        try {
    ...
    private CameraId(String cameraId, @Nullable Integer legacyCameraId) {
        mCameraId = cameraId;
